...
export default async function HomePage() {
  ...
  return (
    <div className="flex-1 w-full flex flex-col items-center">
      ...
      <div className="h-[28rem] w-full border-t border-gray-200 bg-white/10 shadow-[inset_10px_-50px_94px_0_rgb(199,199,199,0.2)] backdrop-blur">
      ...
      <div className="container px-6 py-10 mx-auto -mt-72 sm:-mt-80 md:-mt-96 z-10">
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="flex flex-col p-4 border sm:p-6 rounded-xl dark:border-gray-200">
