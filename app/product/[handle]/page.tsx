      ...
      <div className="flex flex-row justify-center w-[100%] p-4 sm:py-10 sm:px-12 2xl:px-24 rounded-xl border border-gray-200 shadow-lg bg-white max-lg:flex-wrap">
        ...
        <div className="flex flex-col-reverse w-full lg:float-left box-border h-full lg:min-w-[55%] lg:flex-row">
          ...
          <div className="flex justify-center lg:justify-start rounded-xl lg:ml-8 grow shrink basis-auto relative box-border h-full">
            <img src={product.images[mainImageIndex]} className="object-contain h-full sm:max-h-[75vh] rounded-xl" />
          </div>
        ...
        <div className="flex flex-col ml-0 lg:max-w-[750px] gap-12 lg:ml-8">
          ...
          <div className="flex flex-col">
            ...
            <p className="mb-1 font-extrabold text-base sm:text-lg bg-gradient-to-r from-primaryColor to-secondaryColor inline-block text-transparent bg-clip-text capitalize">NEW</p>
            <h1 className="font-semibold text-4xl sm:text-5xl mb-4">{product.name}</h1>

            <div className="flex justify-between mb-3">
              <h2 className="font-semibold text-2xl sm:text-3xl text-gray-700">Rs. {product.price}</h2>
              {
                product.quantity > 0 ?
                  <p className="text-primaryColor text-xl sm:text-2xl font-semibold">In Stock</p>
                  :
                  <p className="text-primaryColor text-xl sm:text-2xl font-semibold">Sold Out</p>
              }
            </div>
            ...
            <div className="flex justify-between mb-4">
              ...
              <div className="max-sm:min-w-[20%] max-sm:max-w-[20%] max-2xl:min-w-[25%] max-2xl:max-w-[25%]">
                <div className="h-full xs:w-full rounded-md inline-flex items-center justify-between bg-neutral-800">
                  ...
                  <span className="text-base text-black bg-white h-full w-full px-4 py-2 sm:px-6 sm:py-3 border border-neutral-800">{itemCount}</span>
                  <button type="button"
                    className="text-white transition duration-200 px-2 sm:px-4 hover:scale-125"
                    onClick={() => {
              ...
              <button className="max-sm:min-w-[50%] max-sm:max-w-[50%] max-2xl:min-w-[55%] max-2xl:max-w-[55%] w-full xl:ml-10 block px-5 text-base sm:text-lg font-medium tracking-wider text-center text-white transition-colors duration-300 transform bg-neutral-800 rounded-md hover:bg-neutral-700">
                Add to Cart
              </button>

            </div>

            <button className="w-full block px-5 py-[7px] sm:py-[11px] text-base sm:text-lg font-medium tracking-wider text-center text-neutral-800 transition-colors duration-300 transform bg-white border border-neutral-800 rounded-md hover:text-white hover:bg-neutral-800">
              Buy Now
            </button>
