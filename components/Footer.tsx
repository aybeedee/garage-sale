        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
          <div className="min-[450px]:col-span-2">
            <h1 className="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl">
              Subscribe to get notified of special offers.
            </h1>
            ...
            <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
              <input
                id="email"
                type="text"
                className="px-4 py-2 text-gray-700 bg-white border rounded-md border-gray-200 focus:border-primaryColor focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-primaryColor/10"
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-5 space-y-2">
              ...
              <p className="text-gray-600 transition-colors duration-300 hover:text-primaryColor">
                contact@garagesale.com
              </p>
            </div>
          </div>
